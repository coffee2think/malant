...
<%
ProductOrder porder = (ProductOrder) request.getAttribute("porder");;
%>
		...
		<div class="content">
				...
				<table style="width: -webkit-fill-available; text-align: center;"
					...
					<tr>
						<td><img width=100px; height=100px;
							src="<%=porder.getThumbnailImg()%>"></td>
						<td><%=porder.getProductName()%></td>
						<td><%=porder.getPrice()%></td>
						<td><%=porder.getDeliveryCharge()%></td>
						<td><%=porder.getQuantity()%></td>
						<td><%=porder.getPrice() * porder.getQuantity() + porder.getDeliveryCharge()%></td>
					</tr>
				</table>
			</div>
			...
			<div class="order-inputform">
				...
				<form>
					...
					<br>
					<label>배송메모 : </label>
					<input type="text" id="delivery_note" name="delivery_note"><br>
					<hr>
