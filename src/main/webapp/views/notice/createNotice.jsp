	...
	<div class="createform">
		<form action="/malant/ninsert" method="post"
			...
			%>
				...
				src="/malant/resources/notice/notice_content_img/p.png" 
				style="width: 350px;"> <br>
				<input type="file" id="input-image" name="input-image" onchange="checkImageSelection(this);"> 
				<br> <input type="hidden" name="adminno" value="<%= loginMember.getUserNo() %>" readonly><br>
				 타입 <br> <br> 
				 <input type="radio" name="noticetype" value="NOTICE" checked>  NOTICE
				  ...
				  <input type="radio" name="noticetype" value="BANNER">  BANNER <br>
					...
					이벤트 시작일 (이벤트 타입만 체크하세요):<br> <input type="date"
						name="startDate"><br> <br> 이벤트 종료일 (이벤트 타입만
					체크하세요):<br> <input type="date" name="endDate"><br>
					<input type="submit" value="쓰기"> <br> <br> <br>
					<br>
			<%
			}
			%>
